...
class ImportLcValidationServicesSpec extends Specification {
    ...
    def "validate#SwiftFields rejects invalid X-Character in goodsDescription"() {
        when:
        ec.service.sync().name("moqui.trade.importlc.ImportLcValidationServices.validate#SwiftFields")
            .parameters([
    ...
    def "transition#BusinessState rejects invalid transition"() {
        ...
        when:
        ec.service.sync().name("moqui.trade.importlc.ImportLcValidationServices.transition#BusinessState")
            .parameters([
                instrumentId: "123", 
