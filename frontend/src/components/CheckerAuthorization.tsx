...
export const CheckerAuthorization: React.FC<Props> = ({ instrumentId }) => {
    ...
    return (
        <div className="auth-workspace premium-card">
            ...
            <header className="auth-header">
                <div className="flex justify-between items-center w-full">
                    <div className="status-group">
                        ...
                        <span className="badge secondary">Transaction: IMLC-2026-X1</span>
                    </div>
                    ...
                    <div className="data-grid">
                        ...
                        <div className="data-field delta">
                            ...
                            <div className="delta-box">
                                <span className="old-val">USD 450,000.00</span>
                                <span className="arrow">→</span>
                                <span className="new-val">USD 500,000.00</span>
                            </div>
                        </div>
                        <div className="data-field">
                        ...
                        <div className="data-field delta">
                            ...
                            <div className="delta-box">
                                <span className="old-val">2026-12-31</span>
                                <span className="arrow">→</span>
                                <span className="new-val">2027-01-15</span>
                            </div>
                        </div>
                        <div className="data-field">
            ...
            {showRejectionModal && (
                <div className="modal-overlay">
                    <div className="modal premium-card">
                        ...
                        <textarea placeholder="Specify the reason for returning this transaction..." />
                        <div className="flex justify-end gap-2 mt-4">
                            <button className="btn secondary" onClick={() => setShowRejectionModal(false)}>Cancel</button>
                            <button className="btn danger">Confirm Rejection</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            <style jsx>{`
                .auth-workspace { display: flex; flex-direction: column; height: calc(100vh - 120px); overflow: hidden; background: white; }
                ...
                .modal-overlay { position: fixed; top:0; left:0; right:0; bottom:0; background: rgba(15,23,42,0.5); display: flex; items: center; justify-content: center; z-index: 1000; }
                .modal { width: 450px; padding: 2rem; background: white; }
